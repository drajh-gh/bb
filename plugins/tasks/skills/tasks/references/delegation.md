...
approval needs, and its final outcome there. With no
unambiguous Operations thread, delegation still creates a hidden standalone worker.
Manual threads and threads associated later with `bb tasks attach` keep their
existing visibility and parentage.
